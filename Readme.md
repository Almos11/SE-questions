...
### Общая схема TDD
![Общая схема TDD](img/СхемаTDD.png)
...
- Задачи
  ...
  - Приоритет задачи может меняться в процессе реализации проекта
...
# 11. Стратегии конструирования ПО. Бережливая разработка ПО 
...
# 14. Разработка требований. Выявление требований
...
# 15. Разработка требований. Анализ требований 
...
# 36. Сборка программных проектов. Окружение для сборки. Общие требования к системе сборки.
...
# 44. Лицензированное ПО. Классификация ПО 
### Классификация ПО
- По отношению к собственности
  ...
  - Свободное ПО
    ...
    - Ричард Столлман. 4 свободы ПО:
      ...
      - свобода запуска с любой целью
      - свобода изучения работы программы и адаптация её к своим целям
      - свобода улучшения программы и публикации улучшений, так что всё общество выиграет от этого
...
# 45. Лицензированное ПО. Лицензия GPL

### Лицензия GPL (General Public License)
- Первая версия GPLv1 или просто GPL – 1989 год
- Вторая версия GPLv2 – 1991 год
- Третья версия GPLv3 – 2007 год
- Основная цель – предоставить пользователю права по отношению к ПО:
  - Копирование
  - Модификация
  - Распространение (в том числе коммерческое)
- Принцип «наследования прав» Copyleft
...
# 46. Лицензированное ПО. Лицензия LGPL
### Лицензия LGPL (Lesser General Public License)
- Стандартная общественная лицензия ограниченного применения GNU
- Является компромиссом между GPL и лицензиями типа BSD, MIT и т.п.
- Представлена в 1991 году (LGPL v2)
- Действующая версия – 2007 год
...
# 47. Лицензированное ПО. Лицензии Apache, MIT, Mozilla, BSD 

### Apache License
  - Лицензия на свободное программное обеспечение Apache Software Foundation
  - Версия 2.0 опубликована в 2004
...
### Mozilla License
  ...
  - Действующая версия – 2.0, опубликована 3.01.2012
...
### MIT License
  ...
  - Не является copyleft-лицензией
  - Совместима с GPL
  - 
### BSD License
  - Berkley Software Distribution license (BSD license) — программная лицензия университета Беркли
  - Опубликована в 1983 году
  - Является лицензией на открытое ПО
  - Совместима с GPL
